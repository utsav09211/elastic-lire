...
public class ImageMapper extends Mapper {
    ...
    public static class Builder extends Mapper.Builder<Builder, ImageMapper> {
        ...
        private Map<FeatureEnum, Map<String, Object>> features = new CopyOnWriteHashMap<FeatureEnum, Map<String,Object>>();

        private Map<String, Mapper.Builder> metadataBuilders = new CopyOnWriteHashMap<String, Mapper.Builder>();
        ...
        public ImageMapper build(BuilderContext context) {
            Map<String, Mapper> featureMappers = new CopyOnWriteHashMap<>();
            Map<String, Mapper> hashMappers = new CopyOnWriteHashMap<>();
            Map<String, Mapper> metadataMappers = new CopyOnWriteHashMap<>();
    ...
    public static class TypeParser implements Mapper.TypeParser {
        ...
        public Mapper.Builder parse(String name, Map<String, Object> node, ParserContext parserContext) throws MapperParsingException {
            ...
            Map<String, Object> features = new CopyOnWriteHashMap<>();
            Map<String, Object> metadatas = new CopyOnWriteHashMap<>();
